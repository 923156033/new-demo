...
<section id="content" class="s">
	...
	<form action="setup.svl" method="post" onsubmit="return formSubmit();">
		<ul class="form">
			...
			<li><label class="lb">数据库名称：</label><input id="dbName" name="dbName" type="text" class="text" value="javapmsv14" /><span class="tip-msg">是否创建数据库</span><input id="createDb" name="createDb" type="checkbox" value="true" checked="checked"/></li>
